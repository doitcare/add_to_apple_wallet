...
- **CocoaPods** continues to work unchanged for apps that have not migrated, and for anyone who has turned SPM off with `flutter config --no-enable-swift-package-manager`.
